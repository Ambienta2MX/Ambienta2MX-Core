...
\section{Módulos de Ambienta2MX}
    \include{modules/FriendlyDolphin}
    \include{modules/CuteBunny}
    \include{modules/SmartOwl}
    \include{modules/FastEagle}
    \include{modules/HardAnt}
    \include{modules/AncientTortoise}
    \include{modules/Others}