...
\subsection{Places}
  \lstinputlisting[language=Python]{../Resources/PlacesDoc.js} 

\subsection{Pollution}
  \lstinputlisting[language=Python]{../Resources/PollutionDoc.js} 

\subsection{Weather}
  \lstinputlisting[language=Python]{../Resources/WeatherDoc.js} 
